...
<!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v35/ekka-admin/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jul 2023 11:00:38 GMT -->
<head>
		<meta charset="utf-8" />
							...
							<form action="loginconnect.php" method="post">
								<div class="row">
									<div class="form-group col-md-12 mb-4">
										<input type="text" class="form-control" id="email" placeholder="username" name="del_username">
									</div>
									
									<div class="form-group col-md-12 ">
										<input type="password" class="form-control" id="password" placeholder="Password" name="del_pass">
									</div>
