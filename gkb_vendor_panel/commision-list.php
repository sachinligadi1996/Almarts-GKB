			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						...
						<div>
							<a href="commision.php" class="btn btn-primary"> Add </a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
										...
										<table id="responsive-data-table" class="table" style="width:100%">
											<thead>
												<tr>
													<th>#</th>
													<th>Total payment</th>
													<th>Active member 0-10 x
                                                            RS to share</th>
													<th>Prime member 10 &above x RS to share</th>
													<th> T.D</th>
													<th>Direct income</th>
													<th>S.C</th>
													<th>Level income</th>
											...
											<tbody>
												<?php
												$i = 1;
												$query = "SELECT * FROM `gkb_commision` ORDER BY id DESC";
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="commision_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="commision-list.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
...
if (!empty($_GET['id']) && isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
    ...
    $idd = $_GET['id'];
    $query = "DELETE FROM `gkb_commision` WHERE id='$idd'";
    ...
    echo "<script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'commision-list.php?id=$idd&confirm=true';
                } else {
                    window.location.href = 'commision-list.php';
                }
            });
          </script>";
}
