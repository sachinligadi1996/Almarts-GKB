                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-default">
                                    ...
                                    $sql = "SELECT * FROM `query_vendor` WHERE  id= '$id'";
                                                    ...
                                                    <form class="row g-3" method="post" enctype="multipart/form-data">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="name" placeholder="Enter your name"
                                                                value="<?php echo $show1['name']; ?>" />

                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="inputEmail4" class="form-label">Date</label>
                                                            <input type="date" name="date"
                                                                value="<?php echo $show1['date']; ?>" />
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" id="branch_code" name="branch_code"
                                                                ...
                                                                value="<?php echo $show1['branch_code']; ?>" />
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label">Query</label>
                                                            <textarea name="query" placeholder="Write Your Query"
                                                                id="query"><?php echo $show1['query']; ?></textarea>
                                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    // Corrected SQL Query
    $sql = "UPDATE `query_vendor` SET `name`='$name',`date`='$date',`mobile`='$mob',`branch_code`='$branch',`query`='$query' WHERE `id` = '$id'";
