...
<!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v35/ekka-php/privacy-policy.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jul 2023 11:00:19 GMT -->
<head>
     <meta charset="UTF-8">
...
<body class="terms_condition_page">
    ...
    <!-- Ec breadcrumb start -->
    <div class="sticky-php-next-sec  ec-breadcrumb section-space-mb">
        <div class="container">
            <div class="row">
                <div class="col-12">
...
<!-- footer sec End -->
        ...
        <div class="container">
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-php-btn ec-side-toggle"><i
                            class="fi-rr-menu-burger"></i></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-php-btn ec-side-toggle"><i
                            class="fi-rr-shopping-bag"></i><span
                            class="ec-cart-noti ec-php-count cart-count-lable">3</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="index.php" class="ec-php-btn"><i class="fi-rr-home"></i></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="wishlist.php" class="ec-php-btn"><i class="fi-rr-heart"></i><span
                            class="ec-cart-noti">4</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="login.php" class="ec-php-btn"><i class="fi-rr-user"></i></a>
                </div>
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-php-btn ec-side-toggle">
            <div class="php-icon"><i class="fi-rr-shopping-basket"></i>
            </div>
