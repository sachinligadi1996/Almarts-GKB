...
<body>
    ...
    if(isset($_GET['email']) && isset($_GET['reset_tokan'])){
        date_default_timezone_set('Asia/kolkata');
            ...
            $sql="SELECT * FROM distributor_admin WHERE email = '$_GET[email]' AND resettokan='$_GET[reset_tokan]' AND resettokanexpire='$date'";
    ...
    if(isset($_POST['submit'])) {
        ...
        $update = "UPDATE distributor_admin SET password = '$pass', resettokan = NULL, resettokanexpire = NULL WHERE email ='$email'";
