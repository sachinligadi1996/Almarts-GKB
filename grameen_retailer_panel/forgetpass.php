...
function send($email,$reset_tokan){
    ...
    try {
        ...
        <a href='http://localhost/Grameen%20K%20bazar%20(4)/Grameen%20K%20bazar/grameen_retailer_panel/updatepass.php?email=$email&reset_tokan=$reset_tokan'>Reset Password</a>";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM retailer_admin WHERE email = '$_POST[email]'";
    ...
    if ($result) {
        ...
        if(mysqli_num_rows($result)==1){
            ...
            $date=date("Y-m-d");
            $sql= "UPDATE  retailer_admin SET resettokan='$reset_tokan',resettokanexpire='$date' WHERE email = '$_POST[email]'";
