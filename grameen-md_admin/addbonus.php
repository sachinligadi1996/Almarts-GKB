...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO `Bonuse_to`( `rank`,`achivment_bo`,`gkb_ta`,`month_target`,`month_bo`,`qtly_target`,`qtly_incentive`,`half_year_target`,`half_year_bo`) VALUES ('$rank','$achivment_bo','$gkb_ta','$month_target','$month_bo','$qtly_target','$qtly_incentive','$half_year_target','$half_year_bo')";
