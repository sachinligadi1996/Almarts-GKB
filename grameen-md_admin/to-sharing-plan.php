												...
												<form class="row g-3" method="post" action="#">
													<div class="col-md-6">
														...
														<input type="text" class="form-control slug-title"
															name="level" id="inputEmail4" required>
													</div>
													<div class="col-md-6">
														<label  class="form-label">Membership</label>
														<input type="text" class="form-control slug-title"
															name="membership" id="inputEmail4" required>
													</div>
													<div class="col-md-6">
														<label for="inputEmail4" class="form-label">Member Structure</label>
														<input type="text" class="form-control slug-title"
															name="member_structure" id="inputEmail4">
													</div>
													<div class="col-md-6">
														<label  class="form-label">Margin</label>
														<input type="text" class="form-control slug-title"
															name="margin" id="inputEmail4" required>
													</div>
...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO `gkb_personal_to_plan`( `level`,`membership`,`member_structure`,`margin`) VALUES ('$nam','$desc','$st','$sts')";
