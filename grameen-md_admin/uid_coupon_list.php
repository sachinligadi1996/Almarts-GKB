			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							<h1>UID Coupon List </h1>
							<p class="breadcrumbs"><span><a href="index.php">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Coupon Details
							</p>
						</div>
					</div>
					<div class="row">
									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												$i = 1;
												$query = "SELECT * FROM `uidcoupon` ORDER BY id DESC";
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="uid_coupon_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="uid_coupon_delete.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
