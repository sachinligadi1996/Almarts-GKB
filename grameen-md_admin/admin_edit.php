                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-default">
                                ...
                                $sql = "SELECT * FROM `gkb_admin_details` WHERE  id= '$id'";
                                                ...
                                                <form class="row g-3" method="post" enctype="multipart/form-data">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control slug-title"
                                                            name="admin_name" value="<?php echo $show1['admin_name']; ?>">
                                                        <input type="hidden" name="rand"
                                                            value="<?php echo "GKB_MD_" . rand(1000, 99999) ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="inputEmail4" class="form-label">Admin's
                                                            Mobile*</label>
                                                        <input type="text" class="form-control slug-title"
                                                            name="admin_mob" value="<?php echo $show1['admin_mob']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="inputEmail4" class="form-label">Admin's
                                                            Username*</label>
                                                        <input type="text" class="form-control slug-title"
                                                            name="admin_username" value="<?php echo $show1['admin_username']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="inputEmail4" class="form-label">Admin's
                                                            Password*</label>
                                                        <input type="text" class="form-control slug-title"
                                                            name="admin_pass" value="<?php echo $show1['admin_pass']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text"  name="admin_mail" class="form-control" value="<?php echo $show1['admin_mail']; ?>">
                                                        
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Admin's Aadhar no.*</label>
                                                        <input type="number" class="form-control" id="price2"
                                                            name="admin_adhar" value="<?php echo $show1['admin_adhar']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="quantity1"
                                                            name="admin_add" value="<?php echo $show1['admin_add']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">House no., Building Name*</label>
                                                        <input type="text" class="form-control" id="quantity1"
                                                            name="admin_add1" value="<?php echo $show1['admin_add1']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">City*</label>
                                                        <input type="text" class="form-control" id="quantity1"
                                                            name="admin_add2" value="<?php echo $show1['admin_add2']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">State*</label>
                                                        <input type="text" class="form-control" id="quantity1"
                                                            name="admin_add3" value="<?php echo $show1['admin_add3']; ?>">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Pincode*</label>
                                                        <input type="text" class="form-control" id="quantity1"
                                                            name="admin_add4" value="<?php echo $show1['admin_add4']; ?>">
                                                    </div>
...
if (isset($_POST['save'])) {
    ...
    // Corrected SQL Query
    $sql = "UPDATE `gkb_admin_details` SET `admin_name`='$name',`admin_mob`='$mob',`admin_mail`='$mail',`admin_adhar`='$adhar',`admin_username`='$uname',`admin_pass`='$pass',`admin_add`='$add',`admin_add1`='$add1',`admin_add2`='$add2',`admin_add3`='$add3',`admin_add4`='$add4' WHERE `id` ='$id'";
