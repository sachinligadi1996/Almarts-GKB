                                                ...
                                                <form class="row g-3" method="post" enctype="multipart/form-data">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control slug-title"
                                                            name="sales_manager" id="inputEmail4">
                                                        <input type="hidden" name="rand"
                                                            value="<?php echo "GKB_SALES_" . sprintf('%04d', rand(1, 9999)); ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="quantity1" name="z">
                                                    </div>
                                                    <div class="col-md-6">
...
if (isset($_POST['save'])) {
    ...
    $result = mysqli_query($conn, "SELECT MAX(SUBSTRING_INDEX(sales_manager_id, '_', -1))AS max_id FROM gkb_sales_manager_details");
    $row = mysqli_fetch_assoc($result);
    $max_id = $row['max_id'];
    $next_id = $max_id + 1;
    $rand = "GKB_SALES_" . sprintf('%04d', $next_id);

    // Corrected SQL Query
    $sql = "INSERT INTO `gkb_sales_manager_details`(`sales_manager_id`, `sales_manager`, `sales_mob`, `sales_mail`, `sales_adhar`, `sales_username`, `sales_pass`, `sales_add`, `sales_add1`, `sales_add2`, `sales_add3`, `sales_add4`) VALUES ('$rand','$sname','$mob','$mail','$adhar','$uname','$pass','$add','$add1','$add2','$add3','$add4')";
