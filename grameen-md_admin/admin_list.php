									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												$i = 1;
												$query = "SELECT * FROM `gkb_admin_details` ORDER BY id DESC";
												...
												while ($row = mysqli_fetch_assoc($qury_run)) {
													...
													<tr>
														...
														<td>
															<?php echo $row['head_admin_id'] ?>
														</td>
														<td>
															<?php echo $row['admin_name'] ?>
														</td>
														<td>
															<?php echo $row['admin_mob']; ?>
														</td>
														<td>
															<?php echo $row['admin_mail']; ?>
														</td>
														<td>
															<?php echo $row['admin_adhar']; ?>
														</td>
														<td>
														...
														<td>
															<?php echo $row['admin_add']; ?>
														</td>
														<td>
															<?php echo $row['admin_add1']; ?>
														</td>
														<td>
															<?php echo $row['admin_add2']; ?>
														</td>
														<td>
															<?php echo $row['admin_add3']; ?>
														</td>
														<td>
															<?php echo $row['admin_add4']; ?>
														</td>
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="admin_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="admin_del.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
