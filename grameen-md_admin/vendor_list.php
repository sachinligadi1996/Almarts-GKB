									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												// $i = 1;
												$query = "SELECT * FROM `gkb_vendor_details` ORDER BY id DESC";
												...
												while ($row = mysqli_fetch_assoc($qury_run)) {
													...
													<tr>
														...
														<td>
															<?php echo $row['vendor_cat']; ?>
														</td>
														<td>
															<?php echo $row['vendor_mail']; ?>
														</td>
														<td>
															<?php echo $row['vendor_adhar']; ?>
														</td>
														<td>
															<?php echo $row['vendor_username']; ?>
														</td>
														<td>
															<?php echo $row['vendor_pass']; ?>
														</td>
														<td>
															<?php echo $row['vendor_add']; ?>
														</td>
														<td>
															<?php echo $row['vendor_add1']; ?>
														</td>
														<td>
															<?php echo $row['vendor_add2']; ?>
														</td>
														<td>
															<?php echo $row['vendor_add3']; ?>
														</td>
														<td>
															<?php echo $row['vendor_add4']; ?>
														</td>
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="vendor_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="vendor_del.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
