									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												// $i = 1;
												$query = "SELECT * FROM `gkb_md_admin` ORDER BY id DESC";
												...
												while ($row = mysqli_fetch_assoc($qury_run)) {
													...
													<tr>
														...
														<td>
															<?php echo $row['md_username']; ?>
														</td>
														<td>
															<?php echo $row['md_pass']; ?>
														</td>
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	...
																	<a class="dropdown-item" href="md_admin_del.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
