					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.php">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span> Bonus Turn Over
							</p>
						</div>
						<div>
							<a href="personal-payment.php" class="btn btn-primary"> Add </a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												$i = 1;
												$query = "SELECT * FROM `gkb_personal` ORDER BY id DESC";
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="payment_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="payment-list.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
...
if (!empty($_GET['id']) && isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
    ...
    $idd = $_GET['id'];
    $query = "DELETE FROM `gkb_personal` WHERE id='$idd'";
    ...
    echo "<script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'payment-list.php?id=$idd&confirm=true';
                } else {
