					...
					<div class="row">
						<div class="col-12">
							<div class="card card-default">
								...
								$sql = "SELECT * FROM `gkb_mpayout_forms` WHERE  id= '$id'";
												...
												<form class="row g-3" method="post" action="#">
													<div class="col-md-6">
														...
														<input type="text" class="form-control slug-title"
															name="amember_efee" id="inputEmail4" value="<?php echo $show1['amember_efee']; ?>" required>
													</div>
													<div class="col-md-6">
														<label for="inputEmail4" class="form-label">No. of Payout/Consumers</label>
														<input type="text" class="form-control slug-title"
															name="no_of_pconsumer" id="inputEmail4" value="<?php echo $show1['no_of_pconsumer']; ?>" required>
													</div>
													<div class="col-md-6">
														<label for="inputEmail4" class="form-label">Deduct % of pvc on gross</label>
														<input type="text" class="form-control slug-title"
															name="deduct_pvc" id="inputEmail4" value="<?php echo $show1['deduct_pvc']; ?>" required>
													</div>
													<div class="col-md-6">
														<label for="inputEmail4" class="form-label">Calculations</label>
														<input type="text" class="form-control slug-title"
															name="calculations" id="inputEmail4" value="<?php echo $show1['calculations']; ?>" required>
													</div>
...
if (isset($_POST['submit']))
{
   ...
   $query = "UPDATE `gkb_mpayout_forms` set amember_efee='$nam',no_of_pconsumer='$desc',deduct_pvc='$st',calculations='$sts' WHERE id='$id'";
...
header("location:mpayout-forms-list.php");
