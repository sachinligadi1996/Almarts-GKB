...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-dark ec-header-light" id="body">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" id="fees" name="fees" class="form-control" required  oninput="calculateTotal()">
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="gst">GST [Percent]:</label>
            <input type="text" id="gstPercentage" name="gstPercentage" class="form-control" oninput="calculateTotal()">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" id="overFees" name="overall_fees" class="form-control">
        </div>
        <div class="form-group col-md-6">
            <label for="agpPercentage">AGP Funds In %:</label>
            <input type="text" id="agpPercentage" name="agp_funds_percent" class="form-control" oninput="calculateTotal()">
        </div>
        <div class="form-group col-md-6">
            <label for="agpAmount">AGP Funds In Rs:</label>
            <input type="text" id="agpAmount" name="agp_funds_rs" class="form-control"  >
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="servicePercentage">Services Charges In %:</label>
            <input type="text" id="servicePercentage" name="services_charges_percent" class="form-control" oninput="calculateTotal()">
        </div>
        <div class="form-group col-md-6">
            <label for="serviceAmount">Services Charges In Rs:</label>
            <input type="text" id="serviceAmount" name="services_charges_rs" class="form-control" >
        </div>
        <div class="form-group col-md-6">
            <label for="mtoTotal">MTO Value:</label>
            <input type="text" id="mtoTotal" name="mto_value" class="form-control">
        </div>
    </div>
...
if (isset($_POST['save'])){
    ...
    $sql = "INSERT INTO membershipmto_plan (membership_type, fees,gstPercentage, gst, overall_fees, agp_funds_percent, agp_funds_rs, services_charges_percent, services_charges_rs, mto_value)
    VALUES ('$membership_type', '$fees',$gst_per,'$gst', '$overall_fees', '$agp_funds_percent', '$agp_funds_rs', '$services_charges_percent', '$services_charges_rs', '$mto_value')";
