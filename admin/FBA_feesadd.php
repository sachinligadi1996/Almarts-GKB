...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO `fba_fees`( `item_range`,`min_rs`,`max_rs`,`final_entry`) VALUES ('$range','$min_rs','$max_rs','$final_entry')";
