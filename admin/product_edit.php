												...
												<form class="row g-3" method="post" enctype="multipart/form-data">
													<div class="col-md-6">
														...
														<input type="text" class="form-control slug-title"
															...
															value="<?php echo $show1['prod_name']; ?>">
													</div>

													<div class="col-md-6">
														<label class="form-label">Select Categories</label>
														<select id="Categories" class="form-select" name="cat"
															value="<?php echo $show1['cat_name'] ?>">
															<option value="<?php echo $show1['cat_name'] ?>">
																<?php echo $show1['cat_name'] ?>
															</option>
															<?php
													...
													<div class="col-md-12">
														...
														<textarea class="form-control" rows="2" name="pro_desc"
															value=""><?php echo $show1['product_descr']; ?></textarea>
													</div>
													<div class="col-md-6">
														<label class="form-label">Old Price</label>
														<input type="number" class="form-control" id="price1"
															name="pro_old_price"
															value="<?php echo $show1['old_price'] ?>">
													</div>
													<div class="col-md-6">
														<label class="form-label">New Price</label>
														<input type="number" class="form-control" id="price2"
															name="pro_new_price"
															value="<?php echo $show1['new_price'] ?>">
													</div>
													<div class="col-md-6">
														<label class="form-label">Quantity</label>
														<input type="number" class="form-control" name="pro_qty" value="<?php echo $show1['quantity'] ?>">
													</div>
													<div class="col-md-6">
														<label class="form-label">Thumb-1</label>
															...
															<input name="oldImg" class="form-control" type="hidden"
																value="<?php echo $show1['thum1']; ?>">
															<img src="<?php echo $show1['thum1']; ?>" width=150
																height="120">
													</div>
													<div class="col-md-6">
														<label class="form-label">Thumb-2</label>
															...
															<input name="oldImg" class="form-control" type="hidden"
																value="<?php echo $show1['thum2']; ?>">
															<img src="<?php echo $show1['thum2']; ?>" width=150
																height="120">
													</div>
													<div class="col-md-6">
														...
														<input name="thumb_3" class="form-control" type="file">
															<input name="oldImg" class="form-control" type="hidden"
																value="<?php echo $show1['thum3']; ?>">
															<img src="<?php echo $show1['thum3']; ?>" width=150
																height="120">
													</div>
													<div class="col-md-12">
...
if (isset($_POST['save'])) {
	...
	`prod_name`= '$pro_name',
	 `cat`= '$pro_cat',
	 `pro_desc`= '$pro_desc',
	  `pro_old_price`= '$pro_old_price',
	   `pro_new_price`-'$pro_new_price',
	    `pro_qty`= '$pro_qty',
		`thum1`= '$folder1',
		 `thum2`= '$folder2',
		  `thum3`='$folder3' 
