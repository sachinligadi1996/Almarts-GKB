        ...
        Closing Fees on FBA <br />
          ...
          <thead>
            <tr>
              ...
              <th scope="col">Min Rs.</th>
              <th scope="col">Max Rs.</th>
              <th scope="col">Final Entry FBA</th>
            ...
            <tbody>
              ...
              <?php
                        $i = 1;
                        $query = "SELECT * FROM `fba_fees` ORDER BY id ASC";
              ...
              <tr>
                ...
                <td><?php echo $row['min_rs']; ?></td>
                <td><?php echo $row['max_rs']; ?></td>
                <td><?php echo $row['final_entry']; ?></td>
                            ...
                            <td>
                              <div class="btn-group mb-1">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="fba_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
                                  <a class="dropdown-item" href="fba_delete.php?id=<?php echo $row['id']; ?>">Delete</a>
                                </div>
                              </div>
                            </td>
              </tr>
