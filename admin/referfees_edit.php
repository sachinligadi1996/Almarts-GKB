            ...
            <div class="col-12">
              <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                  <h2>Refer Fees Edit</h2>
                </div>
                  <?php

                $id = $_GET['id'];

                $sql = "SELECT * FROM `refer_fees` WHERE  id= '$id'";
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control slug-title"
                              name="products" required value="<?php echo $show1['products']; ?>">
                          </div>
                           <div class="col-md-6">
                            <label for="inputEmail4" class="form-label"><=100</label>
                            <input type="text" class="form-control slug-title"
                              name="range_100" value="<?php echo $show1['range_100']; ?>" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">> 100 And <=300</label>
                            <input type="text" class="form-control slug-title"
                              name="range_100-300" value="<?php echo $show1['range_100-300']; ?>" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">>300 And <=500</label>
                            <input type="text" class="form-control slug-title"
                              name="range_300-500" value="<?php echo $show1['range_300-500']; ?>" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">>500 And <=700</label>
                            <input type="text" class="form-control slug-title"
                              name="range_500-700" value="<?php echo $show1['range_500-700']; ?>" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">>700 And <=1000</label>
                            <input type="text" class="form-control slug-title"
                              name="range_700-1000" value="<?php echo $show1['range_700-1000']; ?>" required>
                          </div>
...
if (isset($_POST['submit']))
{
   ...
   $range_700_1000 = $_POST['range_700-1000'];
    ...
    $query = "UPDATE `refer_fees` SET `cat_name`='$cat_name', `products`='$products', `range_100`='$range_100', `range_100-300`='$range_100_300',`range_300-500`='$range_300_500',`range_500-700`='$range_500_700',`range_700-1000`='$range_700_1000' WHERE id=$id ";
