										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="ec-vendor-upload-detail">
												<form class="row g-3" method="post" enctype="multipart/form-data">
													...
													<div class="col-md-6">
														<label class="form-label">Cummission</label>
													...
													<div class="col-md-6">
														...
														<input type="number" class="form-control" name="pro_new_price"
															id="total">
													</div>
													<div class="col-md-6">
...
if (isset($_POST['save'])) {
	...
	$purches_price = $_POST['p_price'];
	$sql = "INSERT INTO `products`(`prod_name`, `cat_name`, `product_descr`, `old_price`, `new_price`, `quantity`,`profit`,`discount`,`pvc`,`cummission`,`p_price`,`thum1`, `thum2`, `thum3`) VALUES ('$pro_name','$pro_cat','$pro_desc','$pro_old_price','$pro_new_price','$pro_qty','$profit','$discount','$pvc','$cummission','$purches_price','$folder1','$folder2', '$folder3')";
