											...
											<tbody>
												...
												while ($row = mysqli_fetch_assoc($qury_run)) {
													...
													<tr>
														...
														<td class="py-1">
															<img src="../products/<?php echo $row['thum1'] ?>"  width='100'
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="v-product_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="v-product_del.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
