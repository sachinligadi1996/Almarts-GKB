      ...
      <div class="ec-content-wrapper">
        <div class="content">
          <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            <div>
              <h1>Add Weight Handling Fees </h1>
...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO `weightfees`( `size_gram`,`local_rs`,`reasonable_rs`,`national_rs`,`international_rs`) VALUES ('$size_gram','$local_rs','$reasonable_rs','$national_rs','$international_rs')";
