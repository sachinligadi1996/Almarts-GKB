...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-dark ec-header-light" id="body">
 ...
 <?php
                                ...
                                $sql = "SELECT * FROM `ven_admin_pro` WHERE  id= '$id'";
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control slug-title"
                                                            name="pro_name" id="inputEmail4" value="<?php echo $product['pro_name']; ?>" required>
                                                    </div>
...
<div class="col-md-6">
    ...
    <input type="number" class="form-control" id="pvc" name="pvc" oninput="calculateTotal()" value="<?php echo $product['pvc']; ?>"  required>
</div>
<div class="col-md-6">
    <label class="form-label">Profit</label>
    <input type="number" class="form-control" id="profit" name="profit" oninput="calculateTotal()" value="<?php echo $product['profit']; ?>"  required>
</div>
<hr>
<div class="col-md-6">
    <label class="form-label">Shipping Fees</label>
    <input type="number" class="form-control" id="ship_fees" name="ship_fees" oninput="calculateTotal()" value="<?php echo $product['ship_fees']; ?>"  required>
</div>
<div class="col-md-6">
    <label class="form-label">Referral Fees</label>
    <input type="number" class="form-control" id="refer_fees" name="refer_fees" oninput="calculateTotal()" value="<?php echo $product['refer_fees']; ?>"  required>
</div>
<div class="col-md-6">
    <label class="form-label">Weight Handling Fees</label>
    <input type="number" class="form-control" id="weight_fees" name="weight_fees" oninput="calculateTotal()" value="<?php echo $product['weight_fees']; ?>"  required>
</div>
<div class="col-md-6">
    <label class="form-label">Closing Fees</label>
    <input type="number" class="form-control" id="close_fees" name="close_fees"   value="<?php echo $product['close_fees']; ?>"  oninput="calculateTotal()" required>
</div>
<div class="col-md-6">
    <label class="form-label">Other Fees</label>
    <input type="number" class="form-control" id="other_fees" name="other_fees" oninput="calculateTotal()" value="<?php echo $product['other_fees']; ?>"  required>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
    ...
    <input type="number" class="form-control" id="total" name="new_price" value="<?php echo $product['new_price']; ?>"  required>
</div>
                                                    <div class="col-md-12">
...
if (isset($_POST['save'])) {
    ...
    $sql = "UPDATE `ven_admin_pro` SET 
        `cinno`='$cinnumber',`gstno`='$gstnumber',`panno`='$pannumber',`tanno`='$tannumber',`hsncode`='$hsncode',
        `pro_name`='$pro_name',`cat_name`='$pro_cat',`pro_desc`='$pro_desc',`batch_code`='$batch_code',
        `bar_code`='$bar_code',`hsn_code`='$hsn_code',`brand_name`='$brand_name',`product_quantity`='$product_quantity',
        `unit`='$unit',`package_quantity`='$package_quantity',`size`='$size',`color`='$color',`material_type`='$material_type',
        `manufacturer_name`='$manufacturer_name',`manufacturer_date`='$manufacturer_date',`expiry_date`='$expiry_date',
        `mrp`='$mrp',`pvc`='$pvc',`profit`='$profit',`other_fees`='$other_fees',`ship_fees`='$ship_fees',`weight_fees`='$weight_fees',
        `close_fees`='$close_fees',`refer_fees`='$refer_fees',`c_price`='$company_price',`discount`='$discount',`new_price`='$new_price',
        `thum1`='$folder1',`thum2`='$folder2',`thum3`='$folder3' WHERE id='$id'";
