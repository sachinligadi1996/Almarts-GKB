                        ...
                        <h3> A] Pick & Pack Per Unit </h3>
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control slug-title"
                              name="standerd" id="inputEmail4" required>
                              </div>
                          
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Bulk Itom</label>
                            <input type="text" class="form-control slug-title"
                              name="bulk_item" required>
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control slug-title"
                              name="cubic_material" id="gkb_ta" required>
                          </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" class="form-control slug-title"
                              name="standerd_ship" id="month_target" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Expidental Shipping</label>
                            <input type="text" class="form-control slug-title"
                              name="expidental_ship" id="month_target" required>
                          </div>
                          <h4> b] Heavy Size </h4>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Standerd Shipping Per Unit</label>
                            <input type="text" class="form-control slug-title"
                              name="standerd_ship_unit" id="month_target" required>
                          </div>
                          <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Expidental Shipping</label>
                            <input type="text" class="form-control slug-title"
                              name="expidental_ship_unit" id="month_target" required>
                          </div>
...
if (isset($_POST['submit']))
{
   ...
   $query = "INSERT INTO `otherfees`( `standerd`,`bulk_item`,`cubic_material`,`standerd_ship`,`expidental_ship`,`standerd_ship_unit`,`expidental_ship_unit`) VALUES ('$standerd','$bulk_item','$cubic_material','$standerd_ship','$expidental_ship','$standerd_ship_unit','$expidental_ship_unit')";
