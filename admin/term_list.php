        ...
        Ship Fees List <br />
          ...
          <thead>
            ...
            <tbody>
              ...
              <?php
                        $i = 1;
                        $query = "SELECT * FROM `term_cond` ORDER BY id ASC";
                        $qury_run = mysqli_query($conn, $query);
                        while ($row = mysqli_fetch_assoc($qury_run)) {
                          ?>
              <tr>
                <th scope="row"><?php echo $i; ?></th>
                <td><?php echo $row['first_input']; ?></td>
                <td><?php echo $row['second_input']; ?></td>
                <td><?php echo $row['third_input']; ?></td>
                            ...
                            <td>
                              <div class="btn-group mb-1">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="term_cond_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
                                  <a class="dropdown-item" href="term_cond_delete.php?id=<?php echo $row['id']; ?>">Delete</a>
                                </div>
                              </div>
                            </td>
              </tr>
