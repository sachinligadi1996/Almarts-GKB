                                                ...
                                                ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            ...
                                                            $unserialize = unserialize($serializedData);

                                                            if (is_array($unserialize)) {
                                                                foreach ($unserialize as $product) {
                                                        ...
                                                        <td>
                                                            <div class="btn-group mb-1">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="order_edit.php?id=<?php echo $row['id']; ?>">Update Order</a>
                                                                    <a class="dropdown-item" href="query_del.php?id=<?php echo $row['id']; ?>">Invoice</a>
                                                                    <a class="dropdown-item" href="order_del.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
