	...
	<div class="wrapper">
		...
		<div class="ec-page-wrapper">
			...
			<div class="ec-content-wrapper">
				<div class="content">
					<h3>Welcome to Stockist Admin Panel</h3>
					<!-- Top Statistics -->

						<!-- Total products -->
						<?php
						$sql3 = "SELECT COUNT(*) AS count_items FROM retailer_prod_inventory";
						...
						<div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-1">
								<div class="card-body">
									...
									<p>Self Inventory</p>
									<!-- Change the class below to your preferred Material Design Icon class -->
						...
						<?php
						$sql = "SELECT COUNT(*) AS count_items FROM orders";
						$query = mysqli_query($conn, $sql);
						$row = mysqli_fetch_array($query);
						$count = $row["count_items"];
						?>
