            ...
            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="breadcrumbs"><span><a href="index.php">Home</a></span>
                                <span><i class="mdi mdi-chevron-right"></i></span>Business Details
                            </p>
                        </div>
                        <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cinNumber"  name="cinnumber" value="<?php echo $show1['cinnumber']; ?>" placeholder="Enter CIN Number">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gstNumber" name="gstnumber" value="<?php echo $show1['gstnumber']; ?>" placeholder="Enter GST Number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="panNumber"  name="pannumber" value="<?php echo $show1['pannumber']; ?>" placeholder="Enter PAN Number">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tanNumber" name="tannumber" value="<?php echo $show1['tannumber']; ?>" placeholder="Enter TAN Number">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hsnCode" name="hsncode"  value="<?php echo $show1['hsncode']; ?>" placeholder="Enter HSN Code">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="stateCode" value="<?php echo $show1['statecode']; ?>" name="statecode">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="batchCode" name="batchcode" value="<?php echo $show1['batchcode']; ?>  placeholder="Enter Batch Code" readonly>
                            </div>
                        </div>
...
<script>
    ...
    function generateBatchCode() {
        ...
        var batchCode = stateCode + month + year;
