									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<?php
												$i = 1;
												$query = "SELECT * FROM `businessdata` ORDER BY id DESC";
												...
												while ($row = mysqli_fetch_assoc($qury_run)) {
													...
													<tr>
														...
														<td>
															<?php echo $row['cinnumber'] ?>
														</td>
														<td>
															<?php echo $row['gstnumber'] ?>
														</td>
														<td>
															<?php echo $row['pannumber']; ?>
														</td>
														<td>
															<?php echo $row['tannumber']; ?>
														</td>
														<td>
															<?php echo $row['hsncode']; ?>
														</td>
														<td>
															<?php echo $row['statecode']; ?>
														</td>
														<td>
														...
														<td>
															<div class="btn-group mb-1">
																...
																<div class="dropdown-menu">
																	<a class="dropdown-item" href="business_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
																	<a class="dropdown-item" href="business_delete.php?id=<?php echo $row['id']; ?>">Delete</a>
																</div>
															</div>
														</td>
													</tr>
